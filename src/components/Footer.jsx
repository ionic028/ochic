...
function Footer() {
  return (
    <div className="w-full flex lg:flex-nowrap flex-wrap gap-5  bg-zinc-900 p-20">
      <div className='w-1/2 flex h-full flex-col justify-between font-["Founders_Grotesk"] mb-9'>
        <div className="heading">
          <h1 className="lg:text-[8vw] text-[30vw]  uppercase leading-none -mb-15">Eye-</h1>
          <h1 className="lg:text-[8vw] text-[30vw]  uppercase leading-none -mb-15">Opening</h1>
        </div>
        {/* <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2 font-['Founders_Grotesk'] flex flex-wrap">
     
          <h1 className="lg:text-[5vw] text-[10vw]  uppercase leading-none -mb-15">Presentations</h1>
